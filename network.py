...
class Network: 
    ...
    def initialize_mobility_topology_design_test(self):
        ...
        :return:
        """
        self.vehicles.append(Vehicle(num_users=20, id=0, pos_x=0, pos_y=1, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=1, pos_x=195, pos_y=1, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=2, pos_x=390, pos_y=2, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=3, pos_x=585, pos_y=2, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=4, pos_x=780, pos_y=2, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=5, pos_x=135, pos_y=32, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=6, pos_x=31, pos_y=17, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=7, pos_x=216, pos_y=15, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=8, pos_x=300, pos_y=20, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=9, pos_x=401, pos_y=35, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=10, pos_x=500, pos_y=3, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=11, pos_x=600, pos_y=10, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=12, pos_x=700, pos_y=10, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=13, pos_x=800, pos_y=10, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=14, pos_x=819, pos_y=10, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=15, pos_x=975, pos_y=10, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=16, pos_x=13, pos_y=20, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=17, pos_x=100, pos_y=20, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=18, pos_x=130, pos_y=20, velocity=1.0, start_direction="right"))
        self.vehicles.append(Vehicle(num_users=20, id=19, pos_x=230, pos_y=20, velocity=1.0, start_direction="right"))
